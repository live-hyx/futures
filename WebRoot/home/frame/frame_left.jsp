...
<meta charset="utf-8" />
	<!-- BEGIN SIDEBAR -->
	<div class="page-sidebar-wrapper" id="page_sidebar_wrapper_div">
		...
		<div class="page-sidebar navbar-collapse collapse" id="sidebar_menu_div">
			...
			<ul id="page_sidebar_menu" class="page-sidebar-menu " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
				...
				<li class="sidebar-toggler-wrapper" id="sidebar_toggle_wrapper_li">
				...
				<li class="sidebar-search-wrapper" id="sidebar_search_wrapper_li">
