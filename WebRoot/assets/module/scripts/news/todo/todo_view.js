...
var Page = function() {
	...
	var submitRecord=function(){
		...
		if(checkInput()==true){
			...
			var url=$("#url").val();
			alert("id:"+id+"title:"+title+"create_time:"+create_time+"description:"+description+"pic_url:"+pic_url+"url:"+url);
			page_form.action="../../"+module+"_"+sub+"_servlet_action?action=modify_record&user_id="+user_id
			+"&title="+title+"&create_time="+create_time+"&description="+description+"&pic_url="+pic_url
			+"&url="+url;
