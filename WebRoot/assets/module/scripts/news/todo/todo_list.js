...
var Record = function() {
	...
	var getRecord = function(){
		...
		var url="../../"+module+"_"+sub+"_servlet_action?action=get_urlrecord&id="+id+"&exist_resultset="+existResultset;
...
var Page = function() {
	...
	var showResult=function(json){
		...
		if(json!=null){
			...
			var tip="当前查询到了 "+list.length+" 条新闻";
	...
	var showRecord = function(json){
		...
		html=html+"																<span>[标题："+title+"][来源："+description+"][发布时间："+createtime+"]</span><p>";
		...
		html=html+"																<button  type=\"button\" class=\"btn-small\"><a href=\""+url+"\" target=\"_blank\">查看新闻</a></button>";
		html=html+"															</div>";
		html=html+"														</div>";
	};
	var help=function(){
