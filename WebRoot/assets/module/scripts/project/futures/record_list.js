...
var Record = function() {
	...
	var initRecordList=function(){
		...
		$('.datatable').dataTable( {
			...
			"oLanguage": {
				...
				"sZeroRecords":  "<span style='color:#ff0000;'>没有找到对应的记录！</span>",
	...
	var addNew=function(){
		...
		var url="../../"+module+"_"+sub+"_servlet_action?action=add_record"+
			"&project_id="+projectId+"&index_id="+indexId+"&index_name="+indexName+"&index_value="+indexValue+"&executor="+
	...
	var processShowRecordById=function(data){
		...
		document.getElementById("index_id").value=list[0][2];
		document.getElementById("index_name").value=list[0][3];
		document.getElementById("index_value").value=list[0][4];
	...
	var modifyRecord1=function(){
		...
		var url="../../"+module+"_"+sub+"_servlet_action?action=modify_record"+
			"&id="+id+"&project_id="+projectId+"&index_id="+indexId+"&index_name="+indexName+"&index_value="+indexValue+"&begin_time="+
