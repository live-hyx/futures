	...
	var initRecordList=function(){
		...
		$('.datatable').dataTable( {
			...
			"aoColumns": [{"mRender": function(data, type, full) {
				sReturn = '<div style="width:100px;"><input type="checkbox" class="checkboxes" value="'+data+'"/></div>';
				return sReturn;
			},"orderable": false
		},{},{},{},{},{}],
...
var Page = function() {
	...
	var layoutRecord=function(){
		if(layout==1)
			window.location.href="normal_list.jsp";
		if(layout==2)
			window.location.href="normal_post.jsp";
	}
