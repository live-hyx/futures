...
var Record = function() {
	...
	var initRecordListHeader = function() {
		...
		html=html+"							<th>交易时间</th>";
		html=html+"							<th>期货指数</th>";
		html=html+"							<th>指数名称</th>";
		html=html+"							<th>期货数目</th>";
		html=html+"							<th>交易类型</th>";
		html=html+"							<th>闭仓价格</th>";
		html=html+"						</tr>";
	...
	var initRecordList=function(){
		...
		url = "../../"+module+"_"+sub+"_servlet_action?action=get_record&exist_resultset="+existResultset;
	...
	var addMoneyInfo=function(){
		console.log("+++++添加关于钱的信息++++++");
		$.post("../../money_manage_back_action?action=get_money",function(e){processMoneyInfo(e)});
		console.log("+++++出来了");
	}
	var processMoneyInfo=function(data){
		console.log("++++++++++ 你有多少钱？ ++++++++++");
		console.log(data);
		var json=eval("("+data+")");
		var money = json.balance;
		console.log(money);
		jQuery("#money_info").html(money);
	}
	return {
		init: function() {
