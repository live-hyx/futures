...
var Page = function() {
	...
	var showRecord = function(json){
		...
		html=html+"		                                                         <span class=\"label label-sm label-success\">[期货索引："+future_index+"][期货名称："+index_name+"][数量：" +
				                                                                     ""+quantity+"][价格："+closing_price+"][创建时间："+create_time+"]</span>";
		html=html+"																<a href="+href+" data-target=\"#ajax\" data-toggle=\"modal\" class=\"btn green btn-xs\">开仓</a><p>";
