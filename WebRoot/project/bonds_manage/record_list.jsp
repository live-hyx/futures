										...
										<div class="col-md-6">
											...
											<div class="btn-group">
												<a id="add_button" class="btn green" 
													href="../property_manage/list_add.jsp">新的交易<i class="fa fa-plus"></i>
												</a>
											</div>
...
<script type="text/javascript"
	src="../../assets/module/scripts/bonds_manage/todo/record_list.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->