									...
									<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
										...
										<div class="form-body">
											...
											<div class="form-group">
												<label class="col-md-3 control-label">交易号码（必填）<font color="red">*</font></label>
												<div class="col-md-9">
													<input type="text" id="trading_number" name="trading_number" class="form-control" placeholder="请填写？？？" value=""/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">期货指数（必填）<font color="red">*</font></label>
												<div class="col-md-9">
