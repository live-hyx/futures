								...
								<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
									...
									<div class="form-body">
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" id="index_name" name="index_name" class="form-control" placeholder="请填写名称" value="" />
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">
											...
											<div class="col-md-9">
												<input type="text" id="index_value" name="index_value" class="form-control" placeholder="请输入" value="" />
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/project/futures/todo_view.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
