									...
									<div class="form-body">
										<div class="form-group">
											<div style="float: left; margin-bottom: 10px; margin-right: 10px; margin-left: 10px; margin-top: 10px;">
												...
												<button type="button" id="search_button" class="btn green" title="设置条件查询对应的记录">
													查询期货
												</button>
											</div>
											<div style="float: left; margin-bottom: 10px; margin-right: 10px; margin-left: 10px; margin-top: 10px;">
												...
												<button type="button" id="export_button" class="btn green" title="导出记录">
													导出
												</button>
											</div>
											<div style="float: left; margin-bottom: 10px; margin-right: 10px; margin-left: 10px; margin-top: 10px;">
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/project/futures/todo_list.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->