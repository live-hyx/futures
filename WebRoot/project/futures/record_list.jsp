							...
							<div class="portlet-body">
								<div class="table-toolbar">
									<div class="row">
										<div class="col-md-6">
											<div class="btn-group">
												<a id="add_button" class="btn green" href="todo_add.jsp">添加新记录
													<i class="fa fa-plus"></i>
												</a>
											</div>
											<div class="btn-group">
												<a id="search_button" class="btn green">查询记录 <i
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/project/futures/record_list.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->