								...
								<div class="portlet-body">
									<div class="table-toolbar">
										<div class="row">
											<div class="col-md-6">
												<div class="btn-group">
													<a id="add_button" class="btn green" href="record_add_div.jsp" data-target="#ajax" data-toggle="modal">添加新用户 <i class="fa fa-plus"></i> </a>
												</div>
												<div class="btn-group">
													<a id="search_button" class="btn green">查询用户 <i class="fa fa-search"></i> </a>
												</div>
												<div class="btn-group">
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/project/todo/record_list.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->