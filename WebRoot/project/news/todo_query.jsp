						...
						<div class="col-md-12">
							<div class="portlet box blue ">
								<div class="portlet-title">
									<div class="caption">
										<i class="fa fa-gift"></i><span id="title_div">新闻查询</span>
									</div>
									<div class="tools">
								...
								<div class="portlet-body form">
									<form class="form-horizontal" role="form" method="post" id="page_form" name="page_form" action="#">
										...
										<div class="form-body">
											...
											<div class="form-group">
												<label class="col-md-3 control-label">新闻标题（必填）<font color="red">*</font></label>
												<div class="col-md-9">
													<input type="text" id="title" name="title" class="form-control" placeholder="请填写新闻标题">
												</div>
											</div>
										</div>
									</form>
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/news/todo/todo_query.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->