...
<%
	...
	String redirectParamName=request.getParameter("redirect_param_name");
%>
<!DOCTYPE html>
	<head>
		<title>期货交易系统系统</title>
							...
							<div class="portlet box blue ">
								...
								<div class="portlet-body form">
									<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
										...
										<input type="hidden" id="redirect_param_name" name="redirect_param_name" value="<%=redirectParamName %>"/>
										<input type="hidden" id="redirect_param" name="redirect_param" value="<%=redirectParam %>"/>
										<div class="form-body">
										</div>
										<div class="form-body">
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/user_manage/todo/result.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
