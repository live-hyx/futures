					...
					<div class="col-md-12">
						<div class="portlet box blue ">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-gift"></i><span id="title_div">查询账单记录</span>
								</div>
								<div class="tools">
								...
								<form class="form-horizontal" role="form" method="post" id="page_form" name="page_form" action="#">
									...
									<div class="form-body">
										<div class="form-group">
											<div style="float: left; margin-bottom: 10px; margin-right: 10px; margin-left: 10px; margin-top: 10px;">
												...
												<!-- 
												<button type="button" id="delete_button" class="btn green" title="设置 条件查询对应的记录">
													提现
												</button>
									...
									<div class="col-md-9">
											<div class="margin-bottom-10">
												<label class="control-label col-md-3">排序显示：</label>
												<select class="bs-select form-control input-small" id="sort_01" data-style="blue" onchange="Page.sortRecord(1)">
													<option value="">(请选择方式)</option>
													<option value="amount">数值</option>
													<option value="create_time">日期</option>
													<option value="op_type">类型</option>
												</select>
												<select class="bs-select form-control input-small" id="sort_02" data-style="blue" onchange="Page.sortRecord(2)">
													<option value="">(请选择方式)</option>
													<option value="amount">数值</option>
													<option value="create_time">日期</option>
													<option value="op_type">类型</option>
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/money_manage/todo/todo_list.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->