				...
				<div class="page-bar" id="page_header_div">
					<ul class="page-breadcrumb">
						<li><i class="fa fa-home"></i> <a
							href="../../home/main/index.jsp">首页</a> <i
							...
							<div class="portlet-body">
										...
										<div class="col-md-6">
											...
											<div class="btn-group">
												<a id="add_button" class="btn green" 
													href="list_add.jsp">充值/提现<i class="fa fa-plus"></i>
												</a>
											</div>
								...
								<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
												<div class="dashboard-stat green-haze">
													...
													<a class="more" href="list_add.jsp">充值/提现<i
...
<script type="text/javascript"
	src="../../assets/module/scripts/money_manage/todo/record_list.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->