					...
					<div class="col-md-12">
						<div class="portlet box blue ">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-gift"></i><span id="title_div">查询持仓记录</span>
								</div>
								<div class="tools">
								...
								<form class="form-horizontal" role="form" method="post" id="page_form" name="page_form" action="#">
									...
									<div class="col-md-9">
											<div class="margin-bottom-10">
												...
												<select class="bs-select form-control input-small" id="sort_01" data-style="green" onchange="Page.sortRecord(1)">
													<option value="">(请选择方式)</option>
													<option value="create_time">日期</option>
													<option value="futures_index">期货指数</option>
													<option value="quantity">交易数量</option>
													
												</select>
												<select class="bs-select form-control input-small" id="sort_02" data-style="green" onchange="Page.sortRecord(2)">
													<option value="">(请选择方式)</option>
													<option value="create_time">日期</option>
													<option value="futures_index">期货指数</option>
													<option value="quantity">交易数量</option>
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/property_manage/todo/todo_list.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->