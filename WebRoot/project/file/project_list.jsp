								...
								<div class="portlet-body form">
									<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
										...
										<div class="form-actions right1">
											<button type="button" id="return_button" class="btn green" title="返回到上一个页面">
												返回
											</button>
											<button type="button" id="search_button" class="btn green" title="设置条件查询项目信息">
												查询记录
											</button>
											<button type="button" id="add_button" class="btn green" title="登记新的项目信息">
												添加登记
											</button>
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/project/file/project_list.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->