								...
								<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
									...
									<div class="form-body">
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<select class="table-group-action-input form-control input-medium" id="apply_type" name="apply_type">
													<option value="">
														（无）
													</option>
													<option value="join_apply">
														项目加入申请
													</option>
													<option value="member">
														班级加入申请
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" id="apply_content" name="apply_content" class="form-control" placeholder="请输入申请的留言" value="" />
											</div>
										</div>
									</div>
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/project/file/member_apply.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->