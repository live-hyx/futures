package  bonds_manage.statistic;
/*
 * 增删改查看导印统功能的实现
...
import bonds_manage.dao.Statistic;
import bonds_manage.dao.StatisticDao;
import bonds_manage.dao.Todo;
import bonds_manage.dao.TodoDao;
...
public class ServletAction extends HttpServlet {
	...
	public void statisticRecord(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(dbName!=null){
			...
			bonds_manage.dao.StatisticDao statisticDao=new bonds_manage.dao.StatisticDao();
		...
		if(isAjax){
			...
			resultUrl="project/bonds_manage/todo_statistic_result.jsp";
