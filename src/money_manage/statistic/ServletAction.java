package money_manage.statistic;
/*
 * 增删改查看导印统功能的实现
...
import money_manage.dao.Statistic;
import money_manage.dao.StatisticDao;
import money_manage.dao.Todo;
import money_manage.dao.TodoDao;
...
public class ServletAction extends HttpServlet {
	...
	public void statisticRecord(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(dbName!=null){
			...
			money_manage.dao.StatisticDao statisticDao=new money_manage.dao.StatisticDao();
			money_manage.dao.Statistic statistic=new money_manage.dao.Statistic();
		...
		if(isAjax){
			...
			resultUrl="project/money_manage/todo_statistic_result.jsp";
