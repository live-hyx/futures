...
import news.dao.Statistic;
import news.dao.StatisticDao;
import news.dao.Todo;
import news.dao.TodoDao;
...
public class ServletAction extends HttpServlet {
	...
	public void statisticRecord(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(dbName!=null){
			...
			news.dao.StatisticDao statisticDao=new news.dao.StatisticDao();
		...
		if(isAjax){
			...
			resultUrl="project/news/todo_statistic_result.jsp";
